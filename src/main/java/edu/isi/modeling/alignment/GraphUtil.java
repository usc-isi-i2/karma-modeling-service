...
//	private static void writeNode(Workspace workspace, Worksheet worksheet, JsonWriter writer, Node node) throws IOException {
	public static void writeNode(JsonWriter writer, Node node, boolean writeNodeAnnotations) throws IOException {
...
//		SemanticTypeUtil semUtil = new SemanticTypeUtil();
	...
	public static void writeLink(JsonWriter writer, DefaultLink link, boolean writeLinkAnnotations) throws IOException {
