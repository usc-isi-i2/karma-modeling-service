package edu.isi.modeling.steiner.topk;
...
//	private static Logger logger = LoggerFactory.getLogger(BANKSfromMM.class);
	...
	public BANKSfromMM_Old(TreeSet<SteinerNode> terminals, Integer recursiveLevel, Integer maxPermutations) throws Exception {
		super(terminals);
