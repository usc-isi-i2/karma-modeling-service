...
public class ColumnNode extends Node {
	...
	public ColumnSemanticTypeStatus getSemanticTypeStatus() {
		if (this.semanticTypeStatus != ColumnSemanticTypeStatus.UserAssigned &&
				this.userSemanticTypes != null && 
				!this.userSemanticTypes.isEmpty())
			return ColumnSemanticTypeStatus.UserAssigned;
		else
		...
		if (userSemanticTypes != null) {
			...
			for (SemanticType st : userSemanticTypes) {
				...
				SemanticType semType = new SemanticType(st.getHNodeId(), 
						...
						Origin.User, 
						confidence);
				this.userSemanticTypes.add(semType);
			}
		}
	}
